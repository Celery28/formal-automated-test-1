...
if __name__ == '__main__':
    ...
    # 测试就业课-笔记源自哪个课程进行跟踪
    testsuite.addTest(cases.PersonalCenterTestCase("test_job_couse_notes_from_which_course"))
    ...
    # 测试就业课-问答列表-进入板块详情页
    testsuite.addTest(cases.PersonalCenterTestCase("test_job_course_QA_plate_details_pages"))
